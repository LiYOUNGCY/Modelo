...
@section('body')
    ...
    <div class="explain">
        <hr class="prize">
        <p>截止6.1日中午15:00时，微博实时热搜榜排名最高男性为：赵本山，指数是105427。获得倒数为724501，参与抽奖人数为263。中奖公式：724501*724501/263余数为151,根据规则，第一种礼遇中奖号码为：<strong>251、88、188、25、125</strong>。请以上中奖号与公众号客服联系，两日后视为放弃。</p>
    </div>
    <div class="explain">
        <hr class="role">
